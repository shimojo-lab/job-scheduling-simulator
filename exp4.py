...
# 共通するlog_idで絞り込み
sampled_log_ids = common_log_ids.sample(SAMPLE_SIZE, random_state=args.exp)[["log_id"]]
...
simulator.run(args.exp, args.method)

end_time = time.time()
print(f"Elapsed time: {(end_time - start_time)/3600:.2f} hours")
